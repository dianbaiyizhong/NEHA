...
import hhm.neha.process.EventDailyPointAnalysisThread;
import hhm.neha.process.EventHourlyPointAnalysisThread;
import hhm.neha.process.EventRealTimePointAnalysisThread;
					...
					{
						{
							...
							statusbar_count.setText(CONTEXT.getMessage("point.statusbar.count", null, Locale.CHINA));
