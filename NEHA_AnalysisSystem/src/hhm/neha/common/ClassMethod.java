...
public class ClassMethod {
	//实时初始化
    public static JSONArray realtimeInit(List<Category_events_eventModel> eventsIds)throws Exception{
    ...
    //24小时初始化
    public static JSONArray hourInit(List<Category_events_eventModel> eventsIds)throws Exception{
    ...
    //7天初始化
    public static JSONArray dailyInit(List<Category_events_eventModel> eventsIds)throws Exception{
    ...
    //24小时和7天的单条数据获取
    public static void DailyAndHourAdd(List<Category_events_eventModel> eventsIds)throws Exception{
  ...
  //实时批量获取
    public static void realtimeAdd(List<Category_events_eventModel> eventsIds)throws Exception{
    	//Map session=ActionContext.getContext().getSession();
    	String events_ids ="";
